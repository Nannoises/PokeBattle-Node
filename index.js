...
app.get('/', function(request, response) {
  ...
  responseText = responseText.replace('FOCUSANIMATEKEY', request.param('FocusAnimate') || false);
  responseText = responseText.replace('FLICKANIMATEKEY', request.param('FlickAnimate') || false);
